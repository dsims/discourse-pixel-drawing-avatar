//duplicated from app/assets/javascripts/discourse/app/components/modal/avatar-selector.gjs
//to use our AvatarUploader to use PixelDrawingModal and hide gravatar
      ...
      <:body>
        ...
        {{#if this.showCustomAvatarSelector}}
          ...
          {{#if this.allowAvatarUpload}}
            {{#if this.siteSettings.gravatar_name}}
              <div class="avatar-choice">
                <RadioButton
                  @id="gravatar"
                  @name="avatar"
